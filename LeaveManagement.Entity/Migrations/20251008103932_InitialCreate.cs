        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HrManagerId = table.Column<int>(type: "integer", nullable: true),
                    DepartmentManagerApprovalDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    HrManagerApprovalDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    DepartmentManagerComments = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    HrManagerComments = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveRequests_Employees_DepartmentManagerId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeaveRequests_Employees_HrManagerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_DepartmentManagerId",
                table: "LeaveRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_HrManagerId",
                table: "LeaveRequests",
                column: "HrManagerId");
